...
class ffElBreadcrumbs2 extends ffThemeBuilderElementBasic {
	protected function _initData() {
		$this->_setData( ffThemeBuilderElement::DATA_ID, 'breadcrumbs-2');
		$this->_setData( ffThemeBuilderElement::DATA_NAME, esc_attr( __('Titlebar 2', 'ark' ) ) );
	...
	protected function _render( ffOptionsQueryDynamic $query, $content, $data, $uniqueId ) {
		...
		$text_color_selectors = array(
			' .breadcrumbs-v2-title' => 'title-color',
			' a' => 'bc-parent-item',
			'.breadcrumbs-v2 .breadcrumbs-v2-links > li > a:hover' => 'bc-parent-item-hover',
			' li + li:before' => 'bc-separator',
			' .breadcrumbs-v2-links > li.active' => 'bc-current-item',
		);
		...
		echo '<h2 class="breadcrumbs-v2-title">';
