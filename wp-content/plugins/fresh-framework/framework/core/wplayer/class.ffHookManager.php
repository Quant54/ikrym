...
################################################################################	
	...
	public function broadcastFakeAjaxRequest( $owner, $data, $specification = null ) {
		$ajaxRequestForFilter = array();
		$ajaxRequestForFilter['owner'] = $owner;
		$ajaxRequestForFilter['data'] = $data;
		$ajaxRequestForFilter['specification'] = $specification;

		$this->_getWPLayer()->do_action('ff_broadcast_fake_ajax', $ajaxRequestForFilter );
	}
################################################################################
# WP_LOADED
################################################################################
