...
/**********************************************************************************************************************/
    ...
    public function generateBreadcrumbs() {
        ...
        switch( $currentType ) {
	        ...
	        case ffConstQuery::POST_TYPE_ARCHIVE:
				$this->_generateBreadcrumbsForPostTypeArchive();
		        break;
...
/**********************************************************************************************************************/
    ...
    private function _generateBreadcrumbForMonth( $year, $month ) {
	    ...
	    $WPLocale = $this->_getWPLayer()->get_wp_locale();
        $breadcrumbItem->name = $WPLocale->get_month( $month );
        $breadcrumbItem->type = 'date';
        $breadcrumbItem->url = $link;
    ...
    private function _generateBreadcrumbsForDate() {
        ...
        switch( $currentInfo->date_type ) {
            ...
            case ffConstQuery::DATE_DAY:
                $day = $this->_getWPLayer()->get_the_date('j');
...
/**********************************************************************************************************************/
	...
	private function _generateBreadcrumbsForPostTypeArchive() {
		$breadcrumbItem = $this->_getBreadcrumbItem();

		$breadcrumbItem->name =   $this->_getWPLayer()->post_type_archive_title('', false);;
		$breadcrumbItem->type =  ffConstQuery::POST_TYPE_ARCHIVE;
		$breadcrumbItem->url =  $this->_getWPLayer()->get_post_type_archive_link( $this->_getWPLayer()->get_post_type());
		$breadcrumbItem->queryType = ffConstQuery::POST_TYPE_ARCHIVE;
//		Shop
//		return $breadcrumbItem;
		$this->_getBreadcrumbsCollection()->addItem( $breadcrumbItem );
	}
